                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="#" data-price="{{ number_format((($prices[$key] / $total_areas[$key]) + 100) * $total_areas[$key], 0) }}" data-toggle="calc-apartment">{{ trans('apartment.calculate') }}</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
