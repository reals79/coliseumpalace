<div id="apartment_types" class="d-inline-block dropdown">
	<a href="#" class="btn btn-link dropdown-toggle" id="dpApartmentTypes" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ trans('apartment.select_apartment') }}</a>
